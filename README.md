...
при совпадении категории - по сумме). Если по расходам в текущем месяце не было записей программа
сообщит об этом. В нижнем меню можно выбрать другой месяц или выйти в подменю работы с таблицей
данных.
...
текущий месяц и их сумму. По умолчанию сортировка по дате (при совпадении даты - по категории,
при совпадении категории - по сумме). Если по доходам в текущем месяце не было записей программа
сообщит об этом. В нижнем меню можно выбрать другой месяц или выйти в подменю работы с таблицей
данных.
...
и доходов по категориям. Если по доходам или расходам в текущем месяце не было записей программа
сообщит об этом. В нижнем меню можно выбрать другой месяц или выйти в подменю работы с таблицей
данных.
...
этой категории в текущем месяце не было записей программа сообщит об этом. В нижнем меню можно
выбрать другой месяц или выйти в подменю работы с таблицей данных.
